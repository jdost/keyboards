...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
 ...
 └────┴─────┴────┴────────┴───────┴────┴─────┴──────┘
   ...
   [EXTENDED1] = LAYOUT(
      ...
      ________, ________, ________, ________, ________, KC_BSLS , KC_LEFT , KC_DOWN , KC_UP   , KC_RGHT , KC_QUOT , ________, \
      ________, ________, ________, ________, ________, ________, KC_LBRC , KC_RBRC , KC_MINS , KC_EQL  , ________, ________, \
      ________, ________, ________,           ________,           ________,           ________, ________, ________  \
   ),
   /* EXTENDED2 LAYER
